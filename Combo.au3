...
Func GUIObjects_Combo(ByRef $this, Const $name, Const $text, Const $left, Const $top, Const $width = -1, Const $height = -1, Const $style = -1, Const $exStyle = -1)
	Local Const $controlID = GUICtrlCreateCombo($text, $left, $top, $width, $height, $style, $exStyle)
